 ...
 *
 * This is a convenience function that generates a UUID specifically
 * for use as request IDs in API handlers and logging.
 *
 * @returns A random UUID v4 string suitable for request tracking
 *
 * @example
 * ```typescript
