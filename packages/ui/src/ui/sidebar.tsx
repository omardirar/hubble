...
// TODO: Improve keyboard navigation and ARIA roles
//   Context: Ensure arrow-key navigation with roving tabindex, proper aria-current/state,
//   labels: area/ui, feature/a11y, type/quality
    ...
    <SidebarContext.Provider value={contextValue}>
      <TooltipProvider delayDuration={0}>
        <div
          ...
          className={cn(
            "group/sidebar-wrapper has-data-[variant=inset]:bg-sidebar flex min-h-[calc(100svh-var(--site-header-height))] w-full",
            className,
          )}
          {...props}
        >
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex h-12 shrink-0 items-center p-2", className)}
      {...props}
    />
  )
}
...
function SidebarMenuSkeleton({
  ...
  React.useEffect(() => {
    // Set a random width after mount to avoid SSR/CSR mismatch
